  ...
  try {
    ...
    writeFileSync(
      ...
      [
        ...
        "  exit /b 0",
        ")",
        // The installer requires known, structured pre-install baselines.
        'if /I "%~2"=="status" if /I not "%~1"=="src/install-plan.mjs" (',
        "  echo {\"mode\":\"native\",\"installed\":false,\"components\":{\"task\":{\"known\":true,\"present\":false},\"wrapper\":{\"known\":true,\"present\":false},\"launcher\":{\"known\":true,\"present\":false},\"shortcut\":{\"known\":true,\"present\":false},\"marker\":{\"known\":true,\"present\":false}}}",
        "  exit /b 0",
        ")",
