...
const doctorRouterPort = String(await openPort());
const doctorManagerPort = String(await openPort());
...
function runDoctor(environment = {}) {
  return spawnSync(process.execPath, [path.join(repoRoot, "src", "doctor.mjs"), "--json"], {
    ...
    env: {
      ...
      CODEX_ROUTER_PORT: doctorRouterPort,
      MODEL_ROUTER_PORT: doctorRouterPort,
      MODEL_ROUTER_CONTROL_PORT: doctorManagerPort,
      ...environment,
    },
    encoding: "utf8",
    timeout: 25_000,
