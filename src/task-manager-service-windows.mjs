...
export async function queryScheduledTask({
  ...
  try {
    ...
    if (
      ...
      || typeof task.currentSid !== "string"
      || typeof task.principalSid !== "string"
      || typeof task.triggerSid !== "string"
      || !task.principal
      || !task.trigger
      || !task.settings
    ...
    return {
      ...
      currentSid: task.currentSid,
      principalSid: task.principalSid,
